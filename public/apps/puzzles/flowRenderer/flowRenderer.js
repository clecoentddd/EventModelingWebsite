...
export function addPiece(r, c, type, name, id) {
  ...
  if (type === 'Automation') innerHTML += `<img src="../flowRenderer/images/automation.png" class="Automation-icon" alt="Automation Icon">`;
...
export function renderAvailablePieces(container, pieces) {
  ...
  pieces.forEach(p => {
    ...
    if (p.type === 'Automation') innerHTML += `<img src="../flowRenderer/images/automation.png" class="Automation-icon" alt="Automation Icon">`;
    el.innerHTML = innerHTML;
