DESCRIPTION: "How to handle an email notification using an external API: we make it explicit here by showing steps that are outside our system. The system will mark the email sent."
LEVEL: 2
