...
TEXT: Produit A; Quantité: 1;
ELEMENT: 2, Command, "Valider Sélection", 1;0
TEXT: panierId: 0x34; articleId: 0x01; produitId: A; Quantité: 1
...
TEXT: articleId: 0x01; produitId: A
ELEMENT: 9, ReadModel, "Liste des articles du panier et quantité", 5;0
TEXT: panierId: 0x34 - Liste :; { articleId: 0x01; produitId: A; Quantité: 1 }
ELEMENT: 10, ExternalEvent, "Alerte Entrepot- rupture de stock", 6;-2
TEXT: ProduitId: A
...
TEXT: produitId: A; panierId: 0x34; Appartient à clientId: 0x55
...
TEXT: produitId: A; Liste des clients :; { clientId : 0x55}
